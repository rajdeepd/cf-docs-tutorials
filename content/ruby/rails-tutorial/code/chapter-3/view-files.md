...
Listing below is the code snippet for `app/views/expenses/_form.html.erb` partial file. Before adding this code make sure that you have added methods in [application_helper.rb](/ruby/rails-tutorial/code/chapter-4/helper-files.html#code-for-application-helper)
...
Here the below given code id for `app/views/expenses/_expense.html.erb` file. Before adding this code make sure that you have added methods in [application_helper.rb](/ruby/rails-tutorial/code/chapter-4/helper-files.html#code-for-application-helper)
